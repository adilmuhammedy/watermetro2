...
const Terminals = () => {
  ...
  const renderTerminalDetails = () => {
      ...
      case 'kakkanad':
        return (
          <div className='terminal2'>
           ...
           <img src='https://www.dropbox.com/s/7ypxoc0yq704q8f/kakkanad.webp?dl=0' className="imgkakka" alt="kakkanad"/>
    ...
    <img src='https://www.dropbox.com/s/vrcbago8ldalwzg/kakkanad1.jpg?dl=0' className='k1' alt='k1'/>
    <img src='https://www.dropbox.com/s/jakshzs8o2cprxu/kakkanad2.jpg?dl=0' className='k2' alt='k2'/>
    <img src='https://www.dropbox.com/s/lx7cr3he4axept7/kakkanad3.jpg?dl=0' className='k3' alt='k3'/>
    <img src='https://www.dropbox.com/s/k7ag2bfhay0z3rn/kakkanad4.jpg?dl=0' className='k4' alt='k4'/>
    <img src='https://www.dropbox.com/s/tu60i4xa02d4z9d/kakkanad5.jpg?dl=0' className='k5' alt='k5'/>
    <img src='https://www.dropbox.com/s/g3huekwstkv3bmd/kakkanad6.jpg?dl=0' className='k6' alt='k6'/>
  ...
  <p className='dessc6'>Economic Zone</p>
      ...
      case 'vyttila':
        return (
          <div className='terminal2'>
            ...
            <img src='https://www.dropbox.com/s/fl5x2cngjqgnypa/vytila.jpg?dl=0' className="imgkakka" alt="vyttila"/>
            <h3 className='nearby'>Nearby Attractions</h3>
            <p className='attractions'>Discover nearby attractions, create memorable experiences, and embark on unforgettable adventures</p>
    ...
    <div className='rect1'>      
    <img src='https://www.dropbox.com/s/xs6xzm2h7rqoy42/vyttila1.jpg?dl=0' className='k1' alt='k1'/>
    <h5 className='placce1'>Edappally</h5>
    <h3 className='locca1'>Lulu Mall</h3>
    <p className='dessc1'>Shopping Mall</p>
    </div> 
    <div className='rect8'> 
    <img src='https://www.dropbox.com/s/vzn9j8mzfm6g9ga/vyttila2.jpg?dl=0' className='k2' alt='k2'/>
    <h5 className='placce2'>Vyttila</h5>
    <h3 className='locca2'>Vyttila Mobility Hub</h3>
    <p className='dessc2'>Hub</p>
    </div> 
    <div className='rect3'> 
    <img src='https://www.dropbox.com/s/ka9fxw4s7krxppz/vyttila3.jpg?dl=0' className='k3' alt='k3'/>
    <h5 className='placce3'>Kochi</h5>
    <h3 className='locca3'> Fort Kochi</h3>
    <p className='dessc3'>Tourist Attraction</p>
    </div> 
    <div className='rect4'> 
    <img src='https://www.dropbox.com/s/2w1mn3ulqr7gnef/vyttila4.jpg?dl=0' className='k4' alt='k4'/>
    <h5 className='placce4'>Thrippunithara</h5>
    <h3 className='locca4'>Hill Palace Museum</h3>
    <p className='dessc4'>Museum</p>
    </div>
    <div className='rect5'>  
    <img src='https://www.dropbox.com/s/vrsajra99i0xejo/vyttila5.jpg?dl=0' className='k5' alt='k5'/>
    <h5 className='placce5'>Kochi</h5>
      ...
      case 'highcourt':
        return (
          <div className="terminal2">
            ...
            <img src="https://www.dropbox.com/s/07g29unxg2j6qjo/high-court.jpg?dl=0"  className="imgkakka" alt="highcourt"/>
            <h3 className='nearby'>Nearby Attractions</h3>
            <p className='attractions'>Discover nearby attractions, create memorable experiences, and embark on unforgettable adventures</p>
            <div className="container">
            <div className='recttt'>
 
    <img src='https://www.dropbox.com/s/eaq8mi2rmfex6br/highcourt1.jpg?dl=0' className='k1' alt='k1'/>
    <img src='https://www.dropbox.com/s/53qjjf2hsv99azc/high2.jpg?dl=0' className='k2' alt='k2'/>
    <img src='https://www.dropbox.com/s/hcj00uvijhdct3d/high3.jpg?dl=0' className='k3' alt='k3'/>
    <img src='https://www.dropbox.com/s/jux30a9pqamoni8/high4.jpg?dl=0' className='k4' alt='k4'/>
    <img src='https://www.dropbox.com/s/fixyu3wj2nvbsvm/high5.jpg?dl=0' className='k5' alt='k5'/>
    <img src='https://www.dropbox.com/s/sg2u9uezfv6rola/high6.jpg?dl=0' className='k6' alt='k6'/>
    <img src='https://www.dropbox.com/s/qhy09c0ijmyvivu/high7.jpg?dl=0' className='k7' alt='k7'/>
      ...
      case 'vypin':
        return (
          <div className='terminal2'> 
            ...
            <img src='https://www.dropbox.com/s/2bqz81uew9ja73l/vypin.webp?dl=0' className="imgkakka" alt="vypin"/>
            <h3 className='nearby'>Nearby Attractions</h3>
            <p className='attractions'>Discover nearby attractions, create memorable experiences, and embark on unforgettable adventures</p>
            <div className="container">
            <div className='recttt'>
    <img src='https://www.dropbox.com/s/q66dfowhcybzse2/vypin1.jpg?dl=0' className='k1' alt='k1'/>
    <img src='https://www.dropbox.com/s/a6lvtcngsw2ac7v/vypin2.webp?dl=0' className='k2' alt='k2'/>
    <img src='https://www.dropbox.com/s/pnbcjqd5detqyag/vypin3.jpg?dl=0' className='k3' alt='k3'/>
    <img src='https://www.dropbox.com/s/stgki9v81qalb2d/vypin4.jpg?dl=0' className='k4' alt='k4'/>
  ...
  return (
    <div className="Home">
      <header className="home-header">
        <img src='https://www.dropbox.com/s/zckq71jrgnv4yvf/logo.png?dl=0' className="logo" alt="watermetro" />
      ...
      <div className="rect2">
          ...
          <h4 className="kakkanad">KAKKANAD</h4>
            <img src='https://www.dropbox.com/s/7ypxoc0yq704q8f/kakkanad.webp?dl=0' className="imgkakkanad-img" alt="kakkanad" onClick={() => handleTerminalClick('kakkanad')} />
          {activeTerminal === 'kakkanad' && renderTerminalDetails()}

        <div>
          <h4 className="vyttila">VYTTILA</h4>
            <img src='https://www.dropbox.com/s/fl5x2cngjqgnypa/vytila.jpg?dl=0' className="imgvyttila" alt="vyttila" onClick={() => handleTerminalClick('vyttila')} />
          {activeTerminal === 'vyttila' && renderTerminalDetails()}
        </div>

        <div>
          <h4 className="highcourt">HIGHCOURT</h4>
            <img src="https://www.dropbox.com/s/07g29unxg2j6qjo/high-court.jpg?dl=0" className="imghighcourt" alt="highcourt" onClick={() => handleTerminalClick('highcourt')}/>
          {activeTerminal === 'highcourt' && renderTerminalDetails()}
        </div>

        <div>
          <h4 className="vypin">VYPIN</h4>
            <img src='https://www.dropbox.com/s/2bqz81uew9ja73l/vypin.webp?dl=0' className="imgvypin" alt="vypin" onClick={() => handleTerminalClick('vypin')} />
          {activeTerminal === 'vypin' && renderTerminalDetails()}
        </div>
      </div>
      {isUserSignedIn && (
      <div className="dropdown">
        <img src='https://www.dropbox.com/s/uu2hs3juypnf0rd/avatar.png?dl=0' alt="Avatar" className="avatar" onClick={toggleDropdown}></img>
